...
// ============================================================
// COLLABORATION CONTACTS - Follow, Contacts, and Blocking
// ============================================================
...
export const GET_NETWORKING_DATA = gql`
	query GetNetworkingData($userId: uuid!) {
		...
		followers: follow(where: { following_id: { _eq: $userId }, status: { _eq: "active" } }) {
			id
			follower {
				id
				display_name
		...
		following: follow(where: { follower_id: { _eq: $userId }, status: { _eq: "active" } }) {
			id
			following {
				id
				display_name
		...
		blocks: user_block(where: { blocker_id: { _eq: $userId } }) {
			id
			blocked_id
			block_collaboration_requests
			block_following
