...
{#if user}
	<nav class="top-nav" aria-label="Main navigation">
		...
		<div class="nav-actions" role="group" aria-label="Primary actions">
			...
			<a href="/settings" class="nav-icon" aria-label="User settings">
				<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
					<path d="M19.14,12.94a7.43,7.43,0,0,0,.05-.94,7.43,7.43,0,0,0-.05-.94l2.11-1.65a.5.5,0,0,0,.12-.64l-2-3.46a.5.5,0,0,0-.6-.22l-2.49,1a7.34,7.34,0,0,0-1.63-.94l-.38-2.65A.5.5,0,0,0,13.74,2H10.26a.5.5,0,0,0-.49.41L9.39,5.06a7.34,7.34,0,0,0-1.63.94L5.27,5a.5.5,0,0,0-.6.22l-2,3.46a.5.5,0,0,0,.12.64L4.9,11.97a7.43,7.43,0,0,0,0,1.88L2.79,15.5a.5.5,0,0,0-.12.64l2,3.46a.5.5,0,0,0,.6.22l2.49-1a7.34,7.34,0,0,0,1.63.94l.38,2.65a.5.5,0,0,0,.49.41h3.48a.5.5,0,0,0,.49-.41l.38-2.65a7.34,7.34,0,0,0,1.63-.94l2.49,1a.5.5,0,0,0,.6-.22l2-3.46a.5.5,0,0,0-.12-.64Zm-7.14,2.56A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z" />
				</svg>
			</a>
		</div>
	</nav>
