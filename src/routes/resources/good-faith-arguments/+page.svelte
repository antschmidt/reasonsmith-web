...
Open Questions: &lt;areas needing clarification or data&gt;</code
	...
	<section class="fallacies">
		...
		<ul class="grid-list">
			<li>
				<strong>Straw Man</strong>: Misrepresenting a position to make it easier to attack. Steelman
				instead.
			</li>
			<li>
			...
			<li>
				<strong>Motte-and-Bailey</strong>: Retreating to a safer vague claim when challenged on a
				strong one.
			</li>
			...
			<li>
				<strong>Cherry Picking</strong>: Selecting only favorable data; ignore the total evidence
				set.
			</li>
	...
	<section class="cult-language">
		...
		<ul class="grid-list">
			<li>
				<strong>Thought-Terminating Clichés</strong>: Stock phrases that end inquiry ("It just is.")
			</li>
			<li>
				<strong>Loaded Language</strong>: Emotionally charged terms replacing neutral description.
			</li>
			<li>
			...
			<li>
				<strong>Reframing Dissent as Moral Failing</strong>: Equating disagreement with disloyalty
				or harm.
			</li>
			<li>
			...
			<li>
				<strong>Purity Spirals</strong>: Ever-tightening standards that render moderation suspect.
			</li>
			...
			<li>
				<strong>Mystification</strong>: Claiming special access to truth to evade evidence requests.
			</li>
		</ul>
		<p class="tip">
